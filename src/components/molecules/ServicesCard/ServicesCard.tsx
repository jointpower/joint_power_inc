...
const ServicesCard = ({ image_src, alt, children }: ServicesCardProps) => {
  return (
    <button className="relative group rounded-lg overflow-hidden w-[300px] md:max-w-[288px] lg:max-w-[388px] md:w-[288px] lg:w-[388px]  h-[227px] md:h-[393px] lg:h-[493px] shrink-0  min-w-[174px] md:min-w-[288px] lg:min-w-[388px]">
      <NextImage
