    ...
    <div className="mt-[120px] ">
        ...
        <Banner text={"Security Guard Companies in Texas"} />
            <div className="text-black max-w-[1300px] px-5 sm:px-10 m-auto gap-10 grid lg:grid-cols-[2.5fr,1fr]">
                <div className="mt-12 ">
                    <h4 className='text-2xl mb-10 text-primary font-bold'>Hire a security guard in California and Texas, <a href="tel:+14244637600"> Call (424)-463-7600.</a></h4>
                    <div className='text-sm'>
                        <p className='leading-6 tracking-wide'>
                        JOINT POWER SECURITY SERVICES INC is the premier security guard services company in the State of California and Texas. We offer security guards and event security to all the major cities in California and  Texas. including security guard services in Austin, Houston, San Antonio, Dallas, Fort Worth, El Paso, Arlington, Corpus Christi, Plano, Laredo, Lubbock, Garland, Irving, Amarillo, Waco, and more. We take great pride in our work throughout California and Texas and the surrounding regions. JOINT POWER SECURITY SERVICES INC boasts an extremely skilled and highly trained staff of uniformed guards, movie film set security, event staff, special event security, trade show security, executive security, on-set security and business security technology consultants that have years of hands-on experience. In Texas, security is paramount, and numerous reputable security companies stand out. JOINT POWER SECURITY SERVICES INC is a prominent name, offering top-notch services. Among the top security guard companies in Texas, our expertise ensures comprehensive protection. With a focus on safeguarding businesses and individuals and maintaining public safety.                          </p>
                        ...
                        Contact JOINT POWER SECURITY SERVICES INC today at <a href="tel:+14244637600"> (424)-463-7600.</a> to learn more about our security services and to see how our security teams can protect you and your business. 
                        </p>
                        ...
                        Austin, Fort Worth, Dallas, Garland, Frisco, El Paso  or somewhere throughout California and Texas </span> then contact Joint Power Service today and put your fears to rest. We provide free consultations and will consider any security concerns or needs regardless of risk.
                        </p>
                        ...
                        <h4 className='text-2xl my-10  mb-0 text-primary font-bold'>Now serving all Major cities in <b>California and Texas</b> .</h4>
                        <p className='leading-6 tracking-wide text-xs'>
                        Joint Power Service provides armed, unarmed, Firewatch and event staff security guards to all of California and  Texas. We are also world famous for our Event and VIP Security Services.
                        </p>
