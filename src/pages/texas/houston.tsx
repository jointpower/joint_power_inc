...
const SecurityGuardInCalifornia = () => {
  ...
  const renderHead = () => {
    return  <Head>
    <title>Security Guard Company in Houston | Joint Power Security Services Inc.</title>
    <meta name="description" content="Hire professional security guards in Houston with Joint Power Security Services Inc. We offer reliable and affordable security solutions for businesses, events, and personal needs across all major cities in Texas." />
    <meta name="keywords" content="security guard services Houston, security company in Houston, hire security guards Houston, fire watch services Houston, event security Houston, VIP protection Houston, mobile patrols Houston, access management Houston, commercial security Houston, security near me, Construction Site Security Houston,  homeless security Houston, hospital security Houston, hotel security Houston, Joint Power Security Houston" />
